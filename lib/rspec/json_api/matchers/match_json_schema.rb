  ...
  module JsonApi
    module Matchers
      ...
      class MatchJsonSchema
        ...
        # Dispatches the parsed actual data to the comparison strategy for the expected schema.
        # @return [Boolean] true if the actual data matches the expected schema.
        def schema_match?
